      ...
      <div className="border-2 rounded-md">
        ...
        <div className="grid grid-cols-2">
          <div className="flex flex-col p-5">
            <h1 className="font-bold p-2 text-left">Sign In</h1>
          ...
          <div className="p-7">
          <span className="pr-4">Don’t have an account yet?</span><span className="text-blue-600">Create new for free!</span>
